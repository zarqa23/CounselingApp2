...
public final class ActivityLauncherBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView splahHeading;

  private ActivityLauncherBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView splahHeading) {
    this.rootView = rootView;
    this.splahHeading = splahHeading;
  }
  ...
  public static ActivityLauncherBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.splah_heading;
      TextView splahHeading = ViewBindings.findChildViewById(rootView, id);
      if (splahHeading == null) {
        break missingId;
      }

      return new ActivityLauncherBinding((ConstraintLayout) rootView, splahHeading);
    }
