...
public class ActivityEditProfileBindingImpl extends ActivityEditProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageArea, 4);
        sViewsWithIds.put(R.id.tv_image, 5);
        ...
        sViewsWithIds.put(R.id.genderHTxt, 19);
        sViewsWithIds.put(R.id.operationArea, 20);
        sViewsWithIds.put(R.id.checkboxMale, 21);
        sViewsWithIds.put(R.id.checkboxFemale, 22);
        sViewsWithIds.put(R.id.tv_type1, 23);
    }
    // views
    @NonNull
